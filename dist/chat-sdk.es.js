import { defineComponent as S, createElementBlock as h, openBlock as f, createElementVNode as o, toDisplayString as H, ref as g, createCommentVNode as k, normalizeClass as z, Fragment as N, renderList as K, watch as q, computed as T, createBlock as I, withDirectives as J, withKeys as Y, vModelText as X, nextTick as B, onUnmounted as Z, onMounted as ee, Transition as te, withCtx as se, createVNode as P, unref as A, reactive as ae, createApp as ne } from "vue";
const oe = { class: "cs-header" }, ie = { class: "cs-header-left" }, re = { class: "cs-avatar" }, ce = {
  ...
  setup(a, { emit: t }) {
    ...
    return (r, v) => (f(), h("div", ve, [
      o("div", ge, [
        o("div", me, [
          o("div", pe, [
            v[0] || (v[0] = o("div", { class: "cs-avatar" }, [
              o("svg", {
                viewBox: "0 0 24 24",
                fill: "currentColor"
              }, [
            ...
            o("div", be, [
              o("div", xe, H(a.welcomeMessage), 1),
              a.showWelcome ? (f(), h("div", ke, "你可以试着问我：")) : k("", !0)
            ])
          ]),
          o("button", {
            ...
            v[2] || (v[2] = o("span", null, "换一换", -1))
          ])
        ]),
        o("div", we, [
          (f(!0), h(N, null, K(a.quickQuestions, (i) => (f(), h("div", {
            key: i.id,
  ...
  viewBox: "0 0 24 24",
  fill: "currentColor"
}, qe = ["src"], De = { class: "cs-message-wrapper" }, Ie = { class: "cs-message-content" }, He = {
  key: 0,
  ...
  setup(a, { emit: t }) {
    const e = a, s = t, n = (l) => {
      e.message.feedback === l ? s("feedback", e.message.id, null) : s("feedback", e.message.id, l);
    };
    return (l, r) => (f(), h("div", {
      class: z(["cs-message-item", `cs-message-${a.message.role}`])
    }, [
      a.message.role === "assistant" ? (f(), h("div", $e, [
        o("div", ze, [
          a.avatar ? (f(), h("img", {
            key: 1,
            src: a.avatar,
      ...
      o("div", De, [
        o("div", {
          ...
          o("div", Ie, H(a.message.content), 1),
          a.message.isStreaming ? (f(), h("div", He, [...r[3] || (r[3] = [
            o("span", { class: "cs-dot" }, null, -1),
            o("span", { class: "cs-dot" }, null, -1),
            o("span", { class: "cs-dot" }, null, -1)
          ])])) : k("", !0)
        ], 2),
        a.message.role === "assistant" && !a.message.isStreaming ? (f(), h("div", Le, [
          o("button", {
            class: z(["cs-feedback-btn", { "cs-feedback-btn-active": a.message.feedback === "like" }]),
            onClick: r[0] || (r[0] = (v) => n("like"))
          }, [...r[4] || (r[4] = [
            o("svg", {
              viewBox: "0 0 24 24",
              fill: "none",
      ...
      a.message.role === "user" ? (f(), h("div", Oe, [...r[6] || (r[6] = [
...
}), je = /* @__PURE__ */ C(Ee, [["__scopeId", "data-v-ee56945d"]]), Ae = { class: "cs-messages-list" }, Be = /* @__PURE__ */ S({
  __name: "MessagesList",
  props: {
    messages: {},
    config: {},
  ...
  setup(a, { emit: t }) {
    ...
    const l = T(() => {
      ...
      if (e.streamingMessageId && n.value) {
        const m = i.findIndex((c) => c.id === e.streamingMessageId);
        if (m >= 0) {
          const c = i[m];
          i[m] = {
            id: c.id,
    ...
    return (i, m) => (f(), h("div", Ae, [
      (f(!0), h(N, null, K(l.value, (c) => (f(), I(je, {
        key: c.id,
        message: c,
        avatar: r(c),
        onFeedback: v
  ...
  setup(a, { expose: t, emit: e }) {
    const s = e, n = g(""), l = g(), r = T(() => n.value.trim().length > 0), v = () => {
    }, i = () => {
  ...
  ref: "scrollContainer"
}, Ge = ["onClick"], Re = { class: "cs-question-text" }, Je = /* @__PURE__ */ S({
  ...
  emits: ["askQuestion"],
  setup(a) {
    return (t, e) => a.quickQuestions.length > 0 ? (f(), h("div", Ue, [
      o("div", We, [
        (f(!0), h(N, null, K(a.quickQuestions, (s) => (f(), h("div", {
          key: s.id,
          class: "cs-question-chip",
          onClick: (n) => t.$emit("askQuestion", s)
        }, [
          o("span", Re, H(s.text), 1)
        ], 8, Ge))), 128))
      ], 512)
    ])) : k("", !0);
  }
...
function et(a = {}) {
  ...
  const v = (d) => {
    ...
    e.value && c(), s.value = null, e.value = !0, n = new AbortController();
    try {
      ...
      let p = "";
      for (; ; ) {
        const { done: y, value: D } = await l.read();
        if (y) {
          if (p.trim()) {
            const j = p.split(`
`);
...
`);
    ...
    n && (n.abort(), n = null), l && (l.cancel(), l = null), e.value = !1;
  }, u = () => {
    c(), t.value = "", s.value = null;
  };
  return Z(() => {
    c();
  }), {
...
function tt(a) {
  const t = g(), e = g(""), { content: s, start: n, reset: l } = et();
  let r = 0;
  q(s, (c) => {
    if (c && c.length > r) {
      const u = c.slice(r);
      e.value += u, r = c.length;
    }
  });
  const v = async (c, u) => {
    l(), r = 0, e.value = "", t.value = Date.now().toString();
    try {
      await n({
        url: u?.sseUrl || a.sseUrl || "http://localhost:3000/sse",
        method: u?.sseMethod || a.sseMethod || "POST",
        body: {
          message: c,
          history: []
        },
        onComplete: () => {
          console.log("✅ 流式传输完成"), t.value && e.value && u?.onComplete?.(t.value, e.value), i();
        },
        onError: (d) => {
          console.error("❌ SSE 错误:", d), e.value += `错误：${d.message}`, t.value && e.value && u?.onComplete?.(t.value, e.value), i();
        }
      });
    } catch (d) {
      console.error("❌ 启动 SSE 失败:", d), e.value += "网络错误，请检查连接", t.value && e.value && u?.onComplete?.(t.value, e.value), i();
    }
  }, i = () => {
...
const at = /* @__PURE__ */ S({
  ...
  setup(a, { emit: t }) {
    const e = a, s = t, n = T(() => e.config.position || "right"), l = T(() => n.value === "left" ? "slide-left" : "slide-right"), r = g(), {
      displayedQuestions: v,
      allQuickQuestions: i,
      refreshQuestions: m
      ...
      scrollToBottom: w,
      watchStreamingContent: L
    } = st(r, u);
    L(), q(() => e.messages, w, { deep: !0 }), q(() => e.isOpen, (p) => {
      p && x();
    }), ee(() => {
    });
    const O = () => {
    ...
    return (p, y) => (f(), I(te, { name: l.value }, {
      default: se(() => [
        a.isOpen ? (f(), h("div", {
          key: 0,
          ...
          o("div", {
            ...
            P(Me, {
              ...
              onAskQuestion: E,
              onRefreshQuestions: O
            }, null, 8, ["welcome-message", "quick-questions", "show-welcome"]),
            a.messages.length > 0 ? (f(), I(Te, {
              key: 0,
              messages: a.messages,
              config: a.config,
              "streaming-message-id": A(c),
              "streaming-content": A(u),
              onFeedback: _
            }, null, 8, ["messages", "config", "streaming-message-id", "streaming-content"])) : k("", !0)
          ], 512),
          a.messages.length > 0 ? (f(), I(Ye, {
            key: 0,
            "quick-questions": A(i),
            onAskQuestion: E
...
}), nt = /* @__PURE__ */ C(at, [["__scopeId", "data-v-fa81ab0e"]]), ot = /* @__PURE__ */ S({
  __name: "ChatSDKApp",
  props: {
    sdk: {
      type: Object,
...
class ct {
  ...
  injectComponentStyles() {
    if (this.shadowRoot && !W.includes("请在构建时自动注入")) {
      const t = document.createElement("style");
   ...
   */
  handleFeedback(t) {
    const { messageId: e, type: s } = t, n = this.messages.value.find((l) => l.id === e);
    ...
    if (this.config.enableHistory)
      try {
        ...
        if (t) {
          ...
          this.messages.value = e.filter((l) => s - l.timestamp < n);
        }
      } catch (t) {
  ...
  async emitAsync(t, e) {
    const s = this.eventListeners.get(t);
    if (s && s.size > 0) {
      const n = Array.from(s).map((l) => Promise.resolve(l(e)));
